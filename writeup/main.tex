...
%----------------------------------------------------------------------------------------
\newcommand{\reporttitle}{A Variational Approach to American Option Pricing via Physics-Informed Neural Networks} % Title of your research project
...
% Acknowledgements
\clearpage
\section*{Plagiarism statement and use of AI}
The work contained in this thesis is my own work unless otherwise stated.

The use of AI tools in this dissertation is limited. I used ChatGPT and Claude to help with researching and understanding some of the mathematical concepts and methods used, but my research was done manually through published, peer-reviewed sources. My implementation of the methods were initially done without AI, which are later debugged and optimised with the help of Claude Code.
\\
...
\input{chapters/mathematical_background.tex}
\input{chapters/black_scholes.tex}
\input{chapters/heston.tex}

...
\end{equation}
then the class of functions $\mathscr F$ that can be represented by a neural network with one hidden layer and activation function $\Psi$ is dense in the space of continuous functions on $S$ and thus is a universal approximator \cite{hornik1989multilayer}.
...
Throughout this project, we will set the improvement threshold to be $10^{-6}$ and the patience to be $500$ iterations, which we found to be a good balance for the models we trained.

...
We will additionally impose a schedule to decay the learning rate over time, which starts at a conventional value of $10^{-3}$ to allow for fast learning at the beginning, and decays by a factor for every certain number of iterations, allowing for finer convergence in later iterations. These are also tuned by observing the training curve, and we choose to decay the learning rate by a factor of $0.7$ every $2000$ iterations.
